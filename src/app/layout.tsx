  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-pilates-cordoba";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Centro Pilates Cordoba Fisioterapia SL"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-pilates-cordoba"
          data-primary-color="#0175bb"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="centro-pilates-cordoba";
